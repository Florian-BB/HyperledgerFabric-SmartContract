...
describe('Asset Transfer Basic Tests', () => {
    ...
    describe('Test CreateAsset', () => {
        it('should return error on CreateAsset', async () => {
            ...
            let assetTransfer = new AssetTransfer();
            try {
                await assetTransfer.CreateAsset(transactionContext, asset.ID, asset.Stat, asset.Size, asset.Model, asset.AppraisedValue);
    ...
    describe('Test TransferAsset', () => {
        ...
        it('should return success on TransferAsset', async () => {
            ...
            let ret = JSON.parse((await chaincodeStub.getState(asset.ID)).toString());
            expect(ret).to.eql(Object.assign({}, asset, {Model: 'Me'}));
        });
    });
    ...
    describe('Test GetAllAssets', () => {
        it('should return success on GetAllAssets', async () => {
            ...
            let expected = [
                {Record: {ID: 'asset1', Stat: 'blue', Size: 5, Model: 'Robert', AppraisedValue: 100}},
                {Record: {ID: 'asset2', Stat: 'orange', Size: 10, Model: 'Paul', AppraisedValue: 200}},
                {Record: {ID: 'asset3', Stat: 'red', Size: 15, Model: 'Troy', AppraisedValue: 300}},
                {Record: {ID: 'asset4', Stat: 'pink', Size: 20, Model: 'Van', AppraisedValue: 400}}
            ];
